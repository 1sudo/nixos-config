" Base16 Glowing Greens vim-airline-theme (https://github.com/dawikur/base16-vim-airline-themes)
" For vim-airline (https://github.com/vim-airline/vim-airline)
" By Florian Warzecha <liketechnik@disroot.org>

let s:scheme_slug = substitute("glowing-greens", "-", "_", "g")
